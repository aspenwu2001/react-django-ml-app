...
class maincontroller:
    def __init__(self):
        ...
        self.__algo = None
        self.__biasPairAddress = 'C:/Users/ASUS/Documents/Algorithm/Algorithm/GenderBiasPair.csv'
        self.__result = {"results": [{"original": "ui", "token": "cv", "bias": 0.7547706271041127, "status": "nbUiased", "synonyms": []}]}
...
#Algorithm related functions
    def algorithm_init(self): #initialise the algorithm structure
        self.__algo = biasAlgorithm(self.__modelFactory.getModel(),self.__biasPairAddress)
